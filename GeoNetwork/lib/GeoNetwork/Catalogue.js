...
GeoNetwork.Catalogue = Ext.extend(Ext.util.Observable, {
    ...
    /** api: config[serverLogin]
     *  ``Boolean`` when this flag is setted to true, assume that GN login is managed in server side (ussually a proxy)
     *  Default is FALSE.
     */
    serverLogin: false,
    ...
    constructor: function(config){
        ...
        var gnFirstParameterSeparator = (serviceUrl.indexOf('?') > -1) ? '&': '?';
        ...
        this.services = {
            ...
            mef: serviceUrl + 'mef.export' + gnFirstParameterSeparator +'format=full&version=2',
            ...
            getMyInfo: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=me',
            getGroups: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=groups',
            getRegions: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=regions',
            getSources: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=sources',
            getUsers: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=users',
            getSiteInfo: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=site&type=auth',
            getInspireInfo: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=inspire',
            getIsoLanguages: serviceUrl + 'isolanguages',
            schemaInfo: serviceUrl + 'xml.schema.info',
            getZ3950repositories: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=z3950repositories',
            getCategories: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=categories',
            getHarvesters: serviceUrl + 'xml.harvesting.get',
            rate: serviceUrl + 'xml.metadata.rate',
            readOnly: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=readonly',
            ...
            getStatus: serviceUrl + 'xml.info' + gnFirstParameterSeparator +'type=status',
            ...
            updatePassword: serviceUrl + 'user.pwedit' + gnFirstParameterSeparator +'id=',
            updateUserInfo: serviceUrl + 'user.infoedit' + gnFirstParameterSeparator +'id=',
