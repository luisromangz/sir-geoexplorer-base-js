                ...
                Ext.Window,
                {
                    ...
                    constructor : function (config) {
                        ...
                        this._barStore = new Ext.data.JsonStore({
                            url : context.baseUrl + '/iniciativasInversion/getMontosGroupBy',
                            storeId : 'barStoreId',
                            root : 'data',
                            idProperty : 'groupBy',
                            fields : [ {
                    ...
                    _createProjectStore : function () {
                        return new Ext.data.Store({
                            ...
                            proxy : new Ext.data.HttpProxy({
                                url : this.baseUrl + '/iniciativasInversion/getFuentes'
                            }),
                            remoteSort : true,
                            autoLoad : true,
                            baseParams : {
                    ...
                    _createYearStore : function () {
                        return new Ext.data.Store({
                            ...
                            proxy : new Ext.data.HttpProxy({
                                url : this.baseUrl + '/iniciativasInversion/getAnyos'
                            }),
                            remoteSort : true,
                            autoLoad : true,
                            baseParams : {
                    ...
                    _createAreaLevelStore : function () {
                        return new Ext.data.Store({
                            ...
                            proxy : new Ext.data.HttpProxy({
                                url : this.baseUrl + '/iniciativasInversion/getNivelesTerritoriales'
                            }),
                            remoteSort : true
                    ...
                    _createLineStore : function () {
                        return new Ext.data.Store({
                            ...
                            proxy : new Ext.data.HttpProxy({
                                url : this.baseUrl + '/iniciativasInversion/getItemsPresupuestarios'
                            }),
                            remotSort : true,
                            autoLoad : false,
                            listeners : {
