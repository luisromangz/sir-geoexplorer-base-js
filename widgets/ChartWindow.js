...
Viewer.dialog.ChartWindow = Ext.extend(
Ext.Window, {
    ...
    _getBarChartCfg: function(formValues, small) {
        ...
        return {
            ...
            visualizationCfg: {
                ...
                title: "Monto Solicitado en sector: " + formValues.sector + " - " + "Fuente: " + formValues.fuente + " - " + "Año: " + formValues.anyo + " - Agrupado por: " + groupingByText
            },
            store: this._barStore,
            columns: [{
                dataIndex: 'groupBy',
