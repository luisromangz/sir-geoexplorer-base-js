...
/**
 * Class: OpenLayers.CustomTileManager
 ...
 * been used. Several maps can share a CustomTileManager instance, in which case each
 * map gets its own tile queue, but all maps share the same tile cache.
 * This control comes from https://github.com/openlayers/openlayers/blob/cd2cd9/lib/OpenLayers/TileManager.js
 */
OpenLayers.CustomTileManager = OpenLayers.Class({
    ...
    /** 
     * Constructor: OpenLayers.CustomTileManager
     * Constructor for a new <OpenLayers.CustomTileManager> instance.
     * 
     * Parameters:
